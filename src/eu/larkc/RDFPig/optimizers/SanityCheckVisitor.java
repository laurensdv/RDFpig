...
public class SanityCheckVisitor extends ExtendedQueryModelVisitor<RuntimeException>  {

	@Override
	public void meet(NWayJoin nWayJoin) {
		if (nWayJoin.getArgs().size()<2)
			throw new IllegalStateException("NWayJoin with less than two arguments");
